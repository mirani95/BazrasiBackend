...
INSTALLED_APPS = [
    ...
    'apps.poultry_inspection.apps.PoultryInspectionConfig',
...
CELERY_BROKER_URL = "redis://:sWEYgGu6sUUv48DPh5JpaTfN@monte-rosa.liara.cloud:33793/0"  # Requires Redis server
accept_content = ["application/json"]
result_serializer = "json"
task_serializer = "json"
timezone = "UTC"
CELERY_RESULT_BACKEND = "redis://:sWEYgGu6sUUv48DPh5JpaTfN@monte-rosa.liara.cloud:33793/0"
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://:sWEYgGu6sUUv48DPh5JpaTfN@monte-rosa.liara.cloud:33793/0",
        "OPTIONS": {
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            "hosts": [("redis://:sWEYgGu6sUUv48DPh5JpaTfN@monte-rosa.liara.cloud:33793/0")],
        },
    },
}
